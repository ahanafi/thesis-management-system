...
@section('content')
    ...
    <div class="content">
        ...
        <div class="row">
                ...
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        ...
                        <div class="block-options">
                            ...
                            @else
                                <a href="#form-supervisor-response" onclick="updateSubmissionAssessmentResponse()" class="btn btn-sm btn-primary">
                                    <i class="fa fa-fw fa-pencil-alt"></i>
                                    <span>Edit Tanggapan</span>
                                </a>
                            @endif
                            <x-button-link link="{{ route('lecturer.submission.final-test.index') }}" text="Kembali"
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(Storage::exists($submission->guidance_card))
                                            <a href="{{ route('lecturer.submission.final-test.download', [
            ...
            <div class="col-sm-12 {{ $submission->status !== \App\Constants\Status::APPLY ? 'd-none invisible' : '' }}" id="form-supervisor-response">
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">
                            <i class="fa fa-fw fa-reply"></i>
                            Form Tanggapan Pengajuan Sidang
                        </h3>
                    </div>
                    <div class="block-content block-content-full">
                        <form action="{{ route('lecturer.submission.final-test.update', $submission->id) }}"
                              method="POST"
                            ...
                            <div class="row push">
                                <div class="col-lg-10 col-xl-10">
                                    <div class="form-group row">
                                        <label for="note" class="col-sm-3 col-form-label text-right">Catatan (Opsional)</label>

                                        <div class="col-sm-9">
                                            <textarea name="note" placeholder="Keterangan" rows="3"
                                                      class="js-summernote">{{ $submission->supervisor_note ?? old('response') }}</textarea>
                                    ...
                                    <div class="form-group row items-push mb-0">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="custom-control custom-block custom-control-success mb-1">
                                                <input type="radio" class="custom-control-input" value="{{ \App\Constants\Status::APPROVE }}"
                                                       id="example-rd-custom-block1" name="supervisor_response" {{ $submission->supervisor_response !== null && $submission->supervisor_response === \App\Constants\Status::APPROVE ? 'checked' : '' }}>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="custom-control custom-block custom-control-danger mb-1">
                                                <input type="radio" class="custom-control-input" value="{{ \App\Constants\Status::REJECT }}"
                                                       id="example-rd-custom-block2" name="supervisor_response" {{ $submission->supervisor_response !== null && $submission->supervisor_response === \App\Constants\Status::REJECT ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-9 offset-sm-3 d-flex justify-content-between">
                                            <input type="hidden" name="supervisor_type" value="{{ $submission->supervisor_type }}" required>
                                            ...
                                            <x-button-link type="secondary"
                                                           link="{{ route('lecturer.submission.final-test.index') }}"
                                                           icon="chevron-left"
                                                           text="Kembali"></x-button-link>
                                            @else
                                                <a href="#" class="btn btn-secondary" onclick="updateSubmissionAssessmentResponse()">
