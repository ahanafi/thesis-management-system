        ...
        <div class="row">
                ...
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        ...
                        <div class="block-options">
                            ...
                            @endif
                            <x-button-link link="{{ route('lecturer.submission.seminar.index') }}" text="Kembali"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(Storage::exists($submission->guidance_card))
                                            <a href="{{ route('lecturer.submission.seminar.download', [
            ...
            <div class="col-sm-12 {{ $submission->status !== \App\Constants\Status::APPLY ? 'd-none invisible' : '' }}" id="form-supervisor-response">
                <div class="block block-rounded">
                    ...
                    <div class="block-content block-content-full">
                        <form action="{{ route('lecturer.submission.seminar.update', $submission->id) }}"
                              method="POST"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-9 offset-sm-3 d-flex justify-content-between">
                                            ...
                                            <x-button-link type="secondary"
                                                           link="{{ route('lecturer.submission.seminar.index') }}"
                                                           icon="chevron-left"
