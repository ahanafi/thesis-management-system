...
class FinalTestController extends Controller
{
    public function index()
    {
        ...
        return viewLecturer('submission.final-test.submissions', compact('submissions'));
    }
    ...
    public function show(SubmissionAssessment $submission)
    {
        ...
        return viewLecturer('submission.final-test.single', compact('submission'));
    }
    ...
    public function update(Request $request, SubmissionAssessment $submission)
    {
        ...
        if ($submission->update()) {
            $message = setFlashMessage('success', 'update', 'pengajuan sidang skripsi');
        } else {
            $message = setFlashMessage('success', 'update', 'pengajuan sidang skripsi');
        }
